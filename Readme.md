...
**You must not use any templates beyond `vector`, `array`, `tuple`, `pair` and `function`. No other containers, no algorithms. You are allowed to use any function from the c standard library.**
